...
const LandingPage = () => {
  ...
  const successStories = [
    ...
    { name: "Harshwardhan Udhani", story: "The future planning feature gave me insights into industry trends and helped me plan my career progression effectively. Highly recommend!" },
    { name: "Mayank Mankar", story: "The interactive chatbot was very helpful in guiding me through the career assessment process. It made everything so much easier!" },
